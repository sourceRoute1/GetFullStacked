...
const perfectFor = ["Complete beginners with no coding experience", "Junior developers wanting to level up", "Founders who want to build their own MVP", "Career switchers looking for tech opportunities"];

const notFor = ["People seeking shortcuts or quick fixes", "Those unwilling to commit 10-15 hours/week", "Advanced developers (this is beginner-focused)", "Anyone not ready to build real projects"];
